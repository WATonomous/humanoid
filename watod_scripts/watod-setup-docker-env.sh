...
SIMULATION_ISAAC_PI_IMAGE=${SIMULATION_ISAAC_PI_IMAGE:-"$REGISTRY_URL/simulation/isaac_pi"}
...
echo "SIMULATION_ISAAC_PI_IMAGE=$SIMULATION_ISAAC_PI_IMAGE" >> "$MODULES_DIR/.env"
