...
import warp as wp
import math
from dextrah_rgb.assets.kuka_allegro.kuka_allegro import KUKA_ALLEGRO_CFG
...
class DextrahKukaAllegroEnvCfg(DirectRLEnvCfg):
    ...
    # RL-Games used reward_shaper.scale_value=0.01; set via CLI for RSL-RL teacher training.
