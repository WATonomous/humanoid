...
class LeRobotSO101Interface:
    ...
    def __init__(
        ...
        self.task_description = "Pick up the vial and place it in the rack"
...
class GR00TRemotePolicy:
    ...
    def connect(self):
        ...
        from humanoid_so101_vial_task.gr00t_client.server_client import PolicyClient
...
class LocalLeRobotPolicy:
    """Run a local LeRobot checkpoint (ACT, etc.) in sim eval."""

    def __init__(
        self,
        robot_iface: LeRobotSO101Interface,
        policy_path: str,
        task_description: str = "Pick up the vial and place it in the rack",
    ) -> None:
        self._iface = robot_iface
    ...
    def get_action(
        ...
        action_values = self._iface.predict_action(obs_frame)
