...
import json
<<<<<<< HEAD:autonomy/simulation/Teleop/external_script/wato_hand_ros2_node.py
import math
import time
...
def mediapipe_to_openxr(landmarks):
    ...
    return hand_poses
>>>>>>> c8398cf7 (Publishing node logic and subscriber node):autonomy/simulation/Teleop/wato_hand/wato_hand_ros2_node.py
