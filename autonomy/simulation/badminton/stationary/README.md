...
`scene/params.yaml` is the single source of truth (shuttle aerodynamics,
...
badminton_mjlab/ the mjlab task: env config, rewards, observations, action moderation, perception command
