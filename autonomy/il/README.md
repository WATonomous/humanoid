...
From `autonomy/teleop/keyboard_based_teleoperation/`:
...
**Keyboard** or **physical SO101 Leader** drives the SO101 follower in sim. From `autonomy/teleop/so101_leader_teleoperation/`:
