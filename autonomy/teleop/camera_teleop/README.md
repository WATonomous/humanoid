...
```bash
source /opt/ros/humble/setup.bash
cd "/workspace/isaaclab/final_repo/humanoid/autonomy/teleop/camera_teleop"
...
cd "autonomy\simulation\Teleop\camera_teleop"
...
| Problem | Fix |
|---------|-----|
| `teleop_tuned_arm_cfg` import error | Check you are running from `camera_teleop/` |
