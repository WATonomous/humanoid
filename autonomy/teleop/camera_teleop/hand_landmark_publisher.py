...
==========================
Runs on a Windows PC (or any machine with a webcam). Reads video from the
webcam, detects hand landmarks with MediaPipe, and publishes them over
rosbridge to the Docker container running Isaac Lab.

This is teleop input only — not dataset recording (see autonomy/il for that).
...
Process:
  ...
  5. Publish the 21 hand landmark positions to /wato/hand_landmarks
"""
import cv2
...
print("Streaming hand landmarks to container. Press q to quit.")
