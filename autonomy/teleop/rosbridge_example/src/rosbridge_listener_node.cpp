...
ROSbridgeListenerNode::ROSbridgeListenerNode() : Node("rosbridge_listener") {
  ...
  hand_pose_sub_ = this->create_subscription<sample_msgs::msg::VRHandPose>(
      "teleop", 10,
      std::bind(&ROSbridgeListenerNode::hand_pose_callback, this, std::placeholders::_1));
}

std::string
ROSbridgeListenerNode::hand_pose_to_string(const sample_msgs::msg::VRHandPose::SharedPtr pose) {
  std::string s;
...
void ROSbridgeListenerNode::hand_pose_callback(const sample_msgs::msg::VRHandPose::SharedPtr msg) {
